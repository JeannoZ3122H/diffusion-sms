...
@Component({
    selector: 'app-list-historique-diffusion',
    standalone: true,
    imports: [MaterialModule, RouterModule, FormsModule, ReactiveFormsModule, DatePipe],
    templateUrl: './list-historique-diffusion.component.html',
    styleUrl: './list-historique-diffusion.component.css'
})
export class ListHistoriqueDiffusionComponent {
